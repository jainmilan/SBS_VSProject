...
public:
  ...
  */
  explicit Environment(fmt::CStringRef binaryDirectory) {
    impl_ = internal::AMPL_Environment_Create_WithBin(binaryDirectory.c_str(), internal::ErrorInfo());
  }
  ...
  */
  void put(fmt::CStringRef name, fmt::CStringRef value) {
    internal::AMPL_Environment_addEnvironmentVariable(impl_, name.c_str(), value.c_str(), internal::ErrorInfo());
  }
  ...
  void setBinDir(fmt::CStringRef binaryDirectory) {
    internal::AMPL_Environment_setBinaryDirectory(impl_, binaryDirectory.c_str(), internal::ErrorInfo());
  }
  /**
  * Get the location where AMPLAPI will search for the %AMPL executable
  */
  std::string getBinDir() const {
    return std::string(internal::AMPL_Environment_getBinaryDirectory(impl_, internal::ErrorInfo()));
  }
  /**
  \rst
  ...
  */
  iterator begin() const {
    return iterator(internal::AMPL_Environment_begin(impl_, internal::ErrorInfo()));
  }
  /**
  Returns an iterator pointing to the past-the-end element in the map:
  */
  iterator end() const {
    return iterator(internal::AMPL_Environment_end(impl_, internal::ErrorInfo()));
  }
  /**
  ...
  */
  iterator find(fmt::CStringRef name) const {
    return iterator(internal::AMPL_Environment_find(impl_, name.c_str(), internal::ErrorInfo()));
  }
