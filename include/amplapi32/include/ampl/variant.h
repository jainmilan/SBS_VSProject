...
template <bool OWNING> class BasicVariant;
...
* Users are not supposed to be used directly, please use
...
public:
  ...
  */
  BasicVariant(const char* value) {
    fromString(value, std::strlen(value));
  }
  /**
  ...
  */
  template <bool U> BasicVariant(BasicVariant<U> const &other) {
    assign(other.impl());
  }
  ...
  */
  template <bool U> BasicVariant &operator=(const BasicVariant<U> &other) {
