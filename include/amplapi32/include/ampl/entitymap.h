...
public:
  ...
  public:
    ...
    */
    typename iterator::value_type operator*() const {
      return typename iterator::value_type(data_->it_->second);
    }
    /**
    Arrow operator
    */
    Proxy operator->() const { return Proxy(data_->it_->second); }
    /**
    Assignment operator
    */
  ...
  */
  iterator find(fmt::CStringRef name) const {
    return iterator(internal::EntityFunctions<EntityClass>::find(impl_, name.c_str()));
  }
