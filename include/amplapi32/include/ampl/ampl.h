...
public:
  ...
  * \param name
  *            Name of the entity
  * \throws An std::out_of_range exception if the specified entity does not exist
  ...
  * \throws An std::out_of_range exception if the specified variable does not
  * exist
  **/
  ...
  * \throws An std::out_of_range exception if the specified constraint does not
  *exist
  **/
  ...
  * \throws An std::out_of_range exception if the specified set does not exist
  **/
  ...
  *             if it does not end with semicolon)
  * @throws runtime_error If the underlying interpreter is not running
  *
  */
  void eval(fmt::CStringRef amplstatements) {
    internal::AMPL_Impl_eval(ampl_, amplstatements.c_str(), internal::ErrorInfo());
  }
  /**
